...
- [Source layout](source_layout.md)
- [Subsystems](subsystems.md)
- [RAM map](ram_map.md)
- [RAM field evidence](ram_fields.md)
- [Naming rules](naming.md)
- [Code quality](code_quality.md)
- [Unknowns registry](unknowns.md)

## Runtime and debugging

- [Runtime evidence](runtime_evidence.md)
- [Runtime-state coverage](runtime_state_coverage.md)
- [Debugger workflow](debugger_workflow.md)
- [Common runtime](common_runtime.md)
- [Shell runtime](shell_runtime.md)

## Data and authoring

- [Authoring coverage](authoring_coverage.md)
...
Chapter-specific evidence is kept in the `world1_*`, `world2_*`, and
`world3_*` documents. [Provenance](provenance.md) records which claims come from
the local image, runtime traces, static analysis, or external references.

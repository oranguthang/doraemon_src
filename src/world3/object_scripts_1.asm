...
World3_BehaviorSetMetaspriteVariant:
    LDA $3E
    STA a:World3EntityMetaspriteVariantBit1,X
    INC a:World3EntityScriptOffset,X
    JMP World3_ExecuteBehaviorCommand
...
World3_BehaviorConditionalBranch:
    LDA $3E
    CMP #$01
...
World3_BehaviorSetFollowAnchor:
    INC a:World3EntityScriptOffset,X
    LDA a:World3EntityScriptOffset,X
    TAY
    LDA ($40),Y
...
World3_BehaviorToggleMetaspriteVariant:

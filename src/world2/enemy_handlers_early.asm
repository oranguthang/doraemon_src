...
Bank1_Label_9C78:
    ...
    JMP World2_ResetEnemyPhaseCounter

Bank1_Label_9C82:
    JMP World2_DeactivateEnemy

World2_RenderTenkoumori:
    LDA #$08
    STA $98
    LDA World2FrameCounter
    AND #$08
...
World2_CommitEnemyCandidatePosition:
    LDA $67

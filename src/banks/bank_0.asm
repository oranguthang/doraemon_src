...
; $856C-$8A6B: World 1 player state, directional movement, and camera-relative positioning
.include "../world1/player_and_camera.asm"
; $8A6C-$8F9D: World 1 object coordinate stepping, animation, and collision helpers
.include "../world1/object_motion.asm"
; $8F9E-$95CA: World 1 entity behavior handlers and object update services
.include "../world1/entity_handlers.asm"
...
; $D770-$E315: World 1 underground object spawning and chapter-specific tables
.include "../world1/underground_objects_and_tables.asm"
